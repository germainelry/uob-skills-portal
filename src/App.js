...
export default function SkillsRecognitionPortal() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-8 bg-gradient-to-br from-gray-100 to-white min-h-screen font-sans overflow-y-auto max-h-screen">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-indigo-500 overflow-y-auto max-h-[85vh]">
        ...
        <div className="space-y-6">
            ...
            <div className="mt-2 space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Walkthrough for deploying Java Spring Boot apps using Jenkins
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Guide to optimizing query speed and avoiding full table scans
                  in large datasets.
                </p>
                <p className="text-xs text-gray-400">
          ...
          {/* Questions */}
          <div>
            <h3 className="text-lg font-bold text-indigo-700">❓ Questions</h3>
            <div className="mt-2 space-y-3">
              <div>
                <h4 className="font-semibold text-indigo-600">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-teal-500 overflow-y-auto max-h-[85vh]">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm">
            🎧 <strong>Apple Airpods Pro 3:</strong> 3000 pts
          </p>
          <p className="text-sm">
